                        ...
                        <div class="flex justify-between items-end">
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">
                                    @{{ report.statistics[0].total }}
                                </p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-medium text-gray-500">
                                    Meta: @{{ report.statistics[0].meta }}
                                </p>
                                <p class="text-2xl font-bold"
                                    :class="report.statistics[0].percentage >= 100 ? 'text-green-600' : 'text-orange-600'">
                            ...
                            <div class="w-full h-6 rounded-full bg-gray-600 dark:bg-gray-700 overflow-hidden">
                                <div :style="'width: ' + Math.min(report.statistics[0].percentage, 100) + '%; height: 100%;'"
                                    :class="[
                                            ...
                                            report.statistics[0].percentage >= 100 ? 'bg-green-500' : 'bg-orange-500'
                                        ]">
                                </div>
                            </div>
