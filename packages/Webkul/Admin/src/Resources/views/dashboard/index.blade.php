<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
        ...
        @include('admin::dashboard.index.client-risk-analysis')
    </div>

    @pushOnce('scripts')
        {{-- app.js is already included in layout, removing redundant 404 script --}}

        <script type="module" src="https://cdn.jsdelivr.net/npm/chart.js/dist/chart.umd.min.js">
        </script>
        ...
        <script type="module">
            ...
            window.strAllUsers = "Todos os Vendedores";
            window.strAllManagers = "Todos os Gerentes";
            window.strManager = "Gerente";
